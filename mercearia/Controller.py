    ...
    def cadastrarProduto(self, nome, preco, categoria, quantidade):
        ...
        if len(h) > 0:
            if len(est) == 0:
                ...
                print('O produto', nome, 'já existe no estoque. Detalhes:')
                for produto_estoque in est:
                    print('Nome:', produto_estoque.produto.nome)
                    print('Preço:', produto_estoque.produto.preco)
                    print('Categoria:', produto_estoque.produto.categoria)
                    print('Quantidade:', produto_estoque.quantidade)
        else:
...
class ControllerVenda:
    def cadastrarVenda(self, nomeProduto, vendedor, comprador, quantidadeVendida):
            ...
            if existe == False:
                if int(i.quantidade) >= int(quantidadeVendida):
                    ...
                    if int(i.quantidade) >= int(quantidadeVendida):
                        ...
                        valorCompra = round(int(quantidadeVendida) * float(i.produto.preco))
        ...
        if existe == False:
            ...
            print('A quantidade vendida não está em estoque')
            return None
        else:

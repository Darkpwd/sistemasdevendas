...
class Fornecedor:
    def _init_(self, nome, cnpj, telefone, categoria):
        self.nome = nome
        self.cnpj = cnpj
...
class Funcionario(Pessoa):
    def _init_(self, clt, nome, telefone, cpf, email, endereco):
        self.clt = clt
        super(Funcionario, self)._init_(nome, telefone, cpf, email, endereco)